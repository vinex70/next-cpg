...
export const perSupplierColumns: ColumnConfig<PerSupplierRows>[] = [
    { field: "kode_supplier", label: "Kode Supplier", isSearchable: true, group: "Info Supplier", groupColor: "bg-green-400" },
    { field: "nama_supplier", label: "Nama Supplier", isSearchable: true, group: "Info Supplier", groupColor: "bg-green-400" },
